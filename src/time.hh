...
#define TOO_SMALL(type) \
    (static_cast<unsigned long long>(INT24_MAX) >= (1ULL << std::numeric_limits<type>::digits) \
...
#undef TOO_SMALL
    ...
    constexpr auto TICKS_PER_UNIT = static_cast<float_type>(ONE_DAY.count()) / static_cast<float_type>(INT24_MAX);

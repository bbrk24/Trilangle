...
The wasm directory contains most of the wrapper/glue code necessary to run the interpreter in a browser. Emscripten 3.1.21 or later and Node 14.17 or later are required.

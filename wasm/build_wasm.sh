...
npx @danielx/civet --js -c worker.civet -o pre.js &
npx @danielx/civet --js -c library.civet -o library.js
wait
...
case "$1" in
    debug)
        ...
        npx @danielx/civet --js --inline-map -c in.civet -o index.js
        npx @danielx/civet --js --inline-map -c Colors.civet -o Colors.js
    ...
    lint)
        ...
        npx @danielx/civet --typecheck ./*.civet
    ...
    *)
        ...
        npx @danielx/civet --js -c in.civet -o - | npx terser -c keep_fargs=false,unsafe=true,unsafe_arrows=true -mo index.js \
            --ecma 12 -f wrap_func_args=false
        npx @danielx/civet --js -c Colors.civet -o - | npx terser -mc keep_fargs=false,keep_classnames=true,unsafe_arrows=true \
